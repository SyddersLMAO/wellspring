...
public class ModEquipmentAssetProvider implements DataProvider {
    ...
    private static void bootstrap(BiConsumer<ResourceKey<EquipmentAsset>, EquipmentClientInfo> output) {
        output.accept(ModArmorMaterials.BAZULIUM_KEY, EquipmentClientInfo.builder()
                .addHumanoidLayers(Identifier.fromNamespaceAndPath(Wellspring.MODID, "bazulium"), false)
                .build());
    }
    ...
    public String getName() {
        return "Wellspring Equipment Definitions";
    }
}
