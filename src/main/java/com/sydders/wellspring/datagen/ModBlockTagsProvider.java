...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(ModBlocks.SIFT_STONE_BRICKS.get())
                .add(ModBlocks.SIFT_STONE_BRICKS_STAIRS.get())
                .add(ModBlocks.SIFT_STONE_BRICKS_SLAB.get())
                .add(ModBlocks.SIFT_STONE_BRICKS_WALL.get())
                ...
                .add(ModBlocks.HARDENED_SIFT_STONE_BRICKS.get())
                .add(ModBlocks.HARDENED_SIFT_STONE_BRICKS_STAIRS.get())
                .add(ModBlocks.HARDENED_SIFT_STONE_BRICKS_SLAB.get())
                .add(ModBlocks.HARDENED_SIFT_STONE_BRICKS_WALL.get())
